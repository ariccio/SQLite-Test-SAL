...
_When_( p != 0, __analysis_assume( _Acquires_lock_( *p ) ) ) SQLITE_API void SQLITE_STDCALL sqlite3_mutex_enter(_In_opt_ sqlite3_mutex* p);
_When_( ( return == SQLITE_OK ) && ( m != 0 ), __analysis_assume( _Acquires_lock_( *m ) ) ) SQLITE_API int SQLITE_STDCALL sqlite3_mutex_try(_In_opt_ sqlite3_mutex* m);
_When_( m != 0, __analysis_assume( _Releases_lock_( *m ) ) ) SQLITE_API void SQLITE_STDCALL sqlite3_mutex_leave(_In_opt_ sqlite3_mutex* m);
