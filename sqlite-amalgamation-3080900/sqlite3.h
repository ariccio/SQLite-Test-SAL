...
** failure.
*/
SQLITE_API SQLITE_API_ANY_RESULT_CODE_INT SQLITE_STDCALL sqlite3_initialize(void);
SQLITE_API SQLITE_API_ANY_RESULT_CODE_INT SQLITE_STDCALL sqlite3_shutdown(void);
SQLITE_API SQLITE_API_ANY_RESULT_CODE_INT SQLITE_STDCALL sqlite3_os_init(void);
SQLITE_API SQLITE_API_ANY_RESULT_CODE_INT SQLITE_STDCALL sqlite3_os_end(void);
...
*/
SQLITE_API SQLITE_API_ANY_RESULT_CODE_INT SQLITE_CDECL sqlite3_config(int, ...);
...
*/
SQLITE_API SQLITE_API_ANY_RESULT_CODE_INT SQLITE_CDECL sqlite3_db_config(sqlite3*, int op, ...);
...
*/
SQLITE_API SQLITE_API_ANY_RESULT_CODE_INT SQLITE_STDCALL sqlite3_complete(_In_z_ const char* sql);
SQLITE_API SQLITE_API_ANY_RESULT_CODE_INT SQLITE_STDCALL sqlite3_complete16(_In_z_ const void *sql);
...
*/
_Check_return_ _Ret_maybenull_ _Post_writable_byte_size_( n ) SQLITE_API void *SQLITE_STDCALL sqlite3_malloc(_In_range_(>=, 1) int n);
...
** method.
*/
SQLITE_API void SQLITE_STDCALL sqlite3_randomness(int N, _Out_writes_bytes_opt_(N) void *P);
...
*/
SQLITE_API SQLITE_API_OK_ONLY_RESULT_CODE_INT SQLITE_STDCALL sqlite3_open(
...
SQLITE_API SQLITE_API_OK_ONLY_RESULT_CODE_INT SQLITE_STDCALL sqlite3_open_v2(
  ...
  _Outptr_ sqlite3 **ppDb,         /* OUT: SQLite db handle */
  int flags,              /* Flags */
  _In_z_ const char* zVfs        /* Name of VFS module to use */
);
...
*/
SQLITE_API int SQLITE_STDCALL sqlite3_limit(_Inout_ sqlite3*, _In_range_( 0, 12 ) int id, int newVal);
...
*/
SQLITE_API int SQLITE_STDCALL sqlite3_stmt_readonly(_In_opt_ sqlite3_stmt *pStmt);
...
*/
SQLITE_API SQLITE_API_OK_ONLY_RESULT_CODE_INT SQLITE_STDCALL sqlite3_finalize(_Inout_opt_ sqlite3_stmt *pStmt);
...
** registered the application defined function.
*/
_Post_equal_to_( p->pOut->db ) _Post_same_lock_( p->pOut->db->mutex, return->mutex ) _Post_satisfies_( return == p->pOut->db )
...
SQLITE_API SQLITE_API_OK_ONLY_RESULT_CODE_INT SQLITE_STDCALL sqlite3_load_extension(
  ...
  _In_z_ const char* zFile,    /* Name of the shared library containing extension */
  _In_opt_z_ const char* zProc,    /* Entry point.  Derived from zFile if 0 */
  _On_failure_( _Outptr_opt_result_z_ )  char **pzErrMsg       /* Put error message here if not 0 */
);
...
struct sqlite3_index_info {
  ...
  _Field_z_ char *idxStr;              /* String, possibly obtained from sqlite3_malloc */
...
SQLITE_API int SQLITE_STDCALL sqlite3_create_module(
  _In_ sqlite3 *db,               /* SQLite connection to register module with */
  _In_z_ const char *zName,         /* Name of the module */
...
SQLITE_API void SQLITE_STDCALL sqlite3_mutex_enter(_In_opt_ _Acquires_lock_( _Curr_ ) _Acquires_lock_( *_Curr_ ) sqlite3_mutex* p);
SQLITE_API int SQLITE_STDCALL sqlite3_mutex_try(_In_opt_ _When_( ( return == SQLITE_OK ), _Acquires_lock_( _Curr_ ) _Acquires_lock_( *_Curr_ ) ) sqlite3_mutex* m);
SQLITE_API void SQLITE_STDCALL sqlite3_mutex_leave(_In_opt_  _Requires_lock_held_( _Curr_ ) _Requires_lock_held_( *_Curr_ ) _Releases_lock_( _Curr_ ) _Releases_lock_( *_Curr_ ) sqlite3_mutex* m);
...
*/
SQLITE_API SQLITE_API_ANY_RESULT_CODE_INT SQLITE_STDCALL sqlite3_file_control(_In_ sqlite3*, _In_opt_z_ const char* zDbName, int op, _Out_ void*);
...
*/
SQLITE_API SQLITE_EXPERIMENTAL _Success_( return == 0 ) int SQLITE_STDCALL sqlite3_stmt_scanstatus(
  sqlite3_stmt *pStmt,      /* Prepared statement for which info desired */
  int idx,                  /* Index of loop to report on */
  int iScanStatusOp,        /* Information desired.  SQLITE_SCANSTAT_* */
  _Out_ void *pOut                /* Result written here */
);     
